...
<head><script src="/docs/5.3/assets/js/color-modes.js"></script>
    ...
    <link rel="stylesheet" href="/style.css?ver_1.1">
...
<main class="d-flex flex-nowrap">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
        <a href="/dashboard" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-stoplights" viewBox="0 0 16 16">
            ...
            <span class="fs-4">Система мониторинга</span>
        </a>
        <hr>
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li>
                <a href="{{route('traffic_lights.list')}}" class="nav-link text-white">
